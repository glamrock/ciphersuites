...
#
# Output:
#   One long list of the top 500 global sites
#
# Credits:   
...
def foo2(data, i)
# if you need/want a new csv output name, change this
  CSV.open("alexa.csv","ab") do |csv|
    data.each{|o| csv << o}
  end
end
 
urls = (0..19).to_a.map{|i| "http://www.alexa.com/topsites/global;#{i} "}
